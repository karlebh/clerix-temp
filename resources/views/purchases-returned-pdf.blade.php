...
<div>
    ...
    <div class="text-right space-y-1 font-bold">
        <p class="text-sm font-semibold">Purchases Returned Report</p>
...
<table class="min-w-full table-auto border-collapse shadow-md rounded-lg overflow-hidden">
    <thead class="">
        <tr>
            ...
            <th class="px-6 py-3 text-left font-medium uppercase text-sm">Returned?</th>
    ...
    <tbody class="text-gray-600">
        @forelse ($purchases as $purchase)
            <tr class="">
                ...
                <td class="px-6 py-4 border-t">{{ $purchase->supplier->name }}</td>
                <td class="px-6 py-4 border-t">${{ number_format($purchase->total_ampount, 2) }}</td>
                <td class="px-6 py-4 border-t">{{ $purchase->is_paid ? 'Yes' : 'No' }}</td>
                <td class="px-6 py-4 border-t">{{ $purchase->is_rturned ? 'Yes' : 'No' }}</td>
